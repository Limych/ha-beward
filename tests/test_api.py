...
from custom_components.beward.api import IntegrationBewardApiClient
...
async def test_api(hass: HomeAssistant, aioclient_mock, caplog):
    ...
    api = IntegrationBewardApiClient("test", "test", async_get_clientsession(hass))
