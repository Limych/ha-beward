...
#     # them to be. Because we have patched the BewardDataUpdateCoordinator.async_get_data
#     # call, no code from custom_components/beward/api.py actually runs.
#     assert await async_setup_entry(hass, config_entry)
#     assert DOMAIN in hass.data and config_entry.entry_id in hass.data[DOMAIN]
#     assert isinstance(
#         hass.data[DOMAIN][config_entry.entry_id], BewardDataUpdateCoordinator
#     )
#
